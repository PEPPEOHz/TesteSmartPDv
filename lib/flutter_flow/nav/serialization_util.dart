    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          ...
          case SelectSomaRow:
            return SelectSomaRow(data);
          case SelectQuantidadeRow:
            return SelectQuantidadeRow(data);
          case QntdeItemRow:
            return QntdeItemRow(data);
          case ProdutoFotoRow:
            return ProdutoFotoRow(data);
          case ProdutosFavoritosRow:
            return ProdutosFavoritosRow(data);
          case PesquisaProdutoRow:
            return PesquisaProdutoRow(data);
          case SelectVendaIdpkRow:
            return SelectVendaIdpkRow(data);
          default:
            return null;
        }
